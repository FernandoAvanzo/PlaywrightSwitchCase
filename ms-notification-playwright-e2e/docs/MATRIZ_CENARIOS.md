...
| CT-007 a CT-012 | tests/02-whatsapp.spec.ts | Local/HML parcial | Envio real só local/mocked |
| CT-013 a CT-020 | tests/03-voucher-adhoc.spec.ts | Local/HML parcial | Fallback controlado por mocks |
...
| E2E-001 a E2E-003 | tests/e2e/voucher-flows.spec.ts | Local | Fluxos integrados de voucher |
| E2E-004 | tests/e2e/routeasy-flow.spec.ts | Local | Webhook até SMS |
| E2E-005 | tests/e2e/app-notification-flow.spec.ts | Local | CRUD de notificação persistida |
